...
namespace RecipeManager.Services
{
    ...
    public interface IRecipeRepository
    {
        ...
        /// </summary>
        /// <param name="recipe">A recipe to be added to the database.</param>
        ...
        /// <param name="recipe">A recipe object which will be used to update the existing database entity.</param>
